...
assert_contains "${ARTICLE_WORKFLOW}" "upsert_var \"LINE_NOTE_ARTICLE_PENDING_ID\" \"\"" "article workflow clears legacy pending article id"
assert_contains "${ARTICLE_WORKFLOW}" "upsert_var \"LINE_NOTE_ARTICLE_PENDING_AT\" \"\"" "article workflow clears legacy pending timestamp"
