...
assert_contains "${PROMPT_FILE}" "Backup-only GitHub Actions dispatch or repository_dispatch for task or audit logging is allowed." "vote prompt allows backup-only GHA dispatch"
