...
PLIST = Path.home() / "Library" / "LaunchAgents" / "com.cursorvers.x-auto-scheduler.plist"
LAUNCHER = Path.home() / ".local" / "bin" / "x-auto-scheduler.sh"
...
def _launchctl_service_text() -> str:
    label = f"gui/{os.getuid()}/com.cursorvers.x-auto-scheduler"
